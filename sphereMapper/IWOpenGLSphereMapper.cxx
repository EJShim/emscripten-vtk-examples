...
std::string GetShader(char* filepath){
...
//-----------------------------------------------------------------------------
vtkStandardNewMacro(IWOpenGLSphereMapper);

//-----------------------------------------------------------------------------
IWOpenGLSphereMapper::IWOpenGLSphereMapper()
{
...
//-----------------------------------------------------------------------------
void IWOpenGLSphereMapper::GetShaderTemplate(
  std::map<vtkShader::Type, vtkShader*> shaders, vtkRenderer* ren, vtkActor* actor)
{
  this->Superclass::GetShaderTemplate(shaders, ren, actor);

  std::string vtkPointGaussianVS = GetShader("resources/glsl/vtkPointGaussianVS.glsl");
  std::string vtkSphereMapperGS = GetShader("resources/glsl/vtkSphereMapperGS.glsl");
  shaders[vtkShader::Vertex]->SetSource(vtkPointGaussianVS.c_str());
  shaders[vtkShader::Geometry]->SetSource(vtkSphereMapperGS.c_str());
}

void IWOpenGLSphereMapper::ReplaceShaderValues(
  std::map<vtkShader::Type, vtkShader*> shaders, vtkRenderer* ren, vtkActor* actor)
{
...
//-----------------------------------------------------------------------------
void IWOpenGLSphereMapper::SetCameraShaderParameters(
...
//-----------------------------------------------------------------------------
void IWOpenGLSphereMapper::SetMapperShaderParameters(
  vtkOpenGLHelper& cellBO, vtkRenderer* ren, vtkActor* actor)
{
...
//-----------------------------------------------------------------------------
void IWOpenGLSphereMapper::PrintSelf(ostream& os, vtkIndent indent)
{
...
void IWOpenGLSphereMapper::CreateVBO(vtkPolyData* poly, vtkIdType numPts, unsigned char* colors,
...
//-------------------------------------------------------------------------
void IWOpenGLSphereMapper::BuildBufferObjects(vtkRenderer* ren, vtkActor* act)
{
...
//----------------------------------------------------------------------------
void IWOpenGLSphereMapper::Render(vtkRenderer* ren, vtkActor* act)
{
...
//-----------------------------------------------------------------------------
void IWOpenGLSphereMapper::RenderPieceDraw(vtkRenderer* ren, vtkActor* actor)
{
  // draw polygons
